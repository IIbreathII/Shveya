		...
		<>
			...
			<div className="mt-3">
				<ul className="list-group">
					...
					<ManagementElement title="Категорії кібер-одягу" number="2" addLink="dashboard/cards/add" link="dashboard/cards" />
					<ManagementElement title="Навчальні матеріали" number="18" addLink="dashboard/cards/add" link="dashboard/cards" />
				</ul>
			</div>
		</>
	);
